...
struct IHexControl {
	...
	virtual bool Copy(int64_t offset = -1, int32_t size = 0) = 0;
	virtual bool Paste(int64_t offset = -1) = 0;
	virtual bool CanCopy() const = 0;
	virtual bool CanPaste() const = 0;
	virtual bool Cut(int64_t offset = -1, int32_t size = 0) = 0;
	virtual bool Delete(int64_t offset = -1, int32_t size = 0) = 0;
